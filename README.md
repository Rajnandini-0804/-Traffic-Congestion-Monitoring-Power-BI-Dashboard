...
## 📊 Dashboard Preview
*( screenshot here )*  
`![Traffic Dashboard](https://github.com/Rajnandini-0804/-Traffic-Congestion-Monitoring-Power-BI-Dashboard/blob/main/Screenshot%202025-12-01%20140734.png)`
...
- Vehicle Count by Location & Congestion Level  
- Traffic Speed Categories (High, Medium, Low)
- Vehicle Type vs Speed (Bike, Car, Scooty, etc.)
